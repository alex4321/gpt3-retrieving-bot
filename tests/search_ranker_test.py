...
def test_search_ranker():
    temp_dir_semantic = tempfile.mkdtemp()
    temp_dir_text = tempfile.mkdtemp()
    try:
        search_semantic = SearchLocalDatabaseSemantic(temp_dir_semantic, "sentence-transformers/all-MiniLM-L6-v2", 2, NNConfig("cuda:0", 8), {})
        ...
        shutil.rmtree(temp_dir_semantic)
